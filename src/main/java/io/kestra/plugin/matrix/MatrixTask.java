    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.matrix.MatrixTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class MatrixTask extends Task implements RunnableTask<MatrixTask.Output> {
    @Schema(
    ...
    @Override
    public MatrixTask.Output run(RunContext runContext) throws Exception {
